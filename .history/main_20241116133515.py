...
from modules import HandDetector, Keyboard
import os
...
typed_text = ''
font_path = 'assets/fonts/arial.ttf'  # Path to a font supporting Cyrillic
font_size = 40
...
while True:
    ...
    # Hand detection
    hands, img = hand_detector.findHands(img, draw=False)  # Set draw=False to not draw hand landmarks
    ...
    text_position = (50, 50)
    draw.text(text_position, typed_text, font=font, fill=(255, 255, 255))
