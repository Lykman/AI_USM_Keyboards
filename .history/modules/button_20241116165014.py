...
class Button:
    ...
    def draw(self, img):
        ...
        button_color = tuple(self.theme['button_color'])
        border_color = tuple(self.theme['border_color'])
        ...
        text_color = tuple(self.theme['text_color'])
    ...
    def draw_hover(self, img):
        ...
        # Преобразуем цвета в кортежи
        hover_color = tuple(self.theme['hover_color'])
        border_color = tuple(self.theme['border_color'])
        ...
        text_color = tuple(self.theme['text_hover_color'])
        draw.text((text_x, text_y), self.text, font=self.font, fill=text_color)
    ...
    def draw_highlight(self, img):
        ...
        # Преобразуем цвета в кортежи
        pressed_color = tuple(self.theme['pressed_color'])
        border_color = tuple(self.theme['border_color'])
        ...
        text_color = tuple(self.theme['text_pressed_color'])
        draw.text((text_x, text_y), self.text, font=self.font, fill=text_color)
