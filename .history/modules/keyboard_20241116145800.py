...
class Keyboard:
    def __init__(self, language='EN', theme='theme1', frame_width=640, frame_height=480):
        ...
        self.buttons = []
        self.font_path = 'assets/fonts/Apple Color Emoji.ttc'  # Путь к шрифту
        self.create_buttons()
    ...
    def create_buttons(self):
        ...
        for i, row in enumerate(self.layout):
            ...
            button_width = (self.frame_width * 0.9 - total_gap) // num_keys  # 90% от ширины кадра под кнопки
            ...
            for j, key in enumerate(row):
                ...
                button = Button(
                    pos=[x, y],
                    size=[int(button_width), int(button_height)],
                    text=key,
                    theme=self.theme,
